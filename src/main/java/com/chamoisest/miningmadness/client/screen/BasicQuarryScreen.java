...
public class BasicQuarryScreen extends BaseScreen<BasicQuarryMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(MiningMadness.MOD_ID,"textures/gui/basic_quarry_gui.png");

    private static final Item blockItem = MMBlocks.BASIC_QUARRY.get().asItem();

    public BasicQuarryScreen(BasicQuarryMenu menu, Inventory inventory, Component component) {
