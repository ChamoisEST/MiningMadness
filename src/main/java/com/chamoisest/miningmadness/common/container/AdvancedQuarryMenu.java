...
public class AdvancedQuarryMenu extends BaseMenu<AdvancedQuarryBlockEntity> {
    ...
    public AdvancedQuarryMenu(int id, Inventory inv, FriendlyByteBuf extraData){
        this(id, inv, (AdvancedQuarryBlockEntity) inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(16));
    }

    public AdvancedQuarryMenu(int id, Inventory inv, AdvancedQuarryBlockEntity entity, ContainerData data){
        super(MMMenuTypes.ADVANCED_QUARRY_MENU.get(), id, inv, entity, data, SLOTS);
    ...
    public boolean stillValid(@NotNull Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, MMBlocks.ADVANCED_QUARRY.get());
    }
