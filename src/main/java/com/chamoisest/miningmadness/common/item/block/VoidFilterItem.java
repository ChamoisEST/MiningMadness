...
public class VoidFilterItem extends BlockItem {
    public VoidFilterItem(Block pBlock, Properties pProperties) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        if(Screen.hasShiftDown()) {
            components.add(Component.translatable("tooltip.miningmadness.void_filter_info"));
